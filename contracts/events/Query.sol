...
string constant ABI = "event Query(uint indexed host, string name, string input, string output, uint id)";
...
abstract contract QueryEvent is EventEmitter {
    ...
    event Query(uint indexed host, string name, string input, string output, uint id);
