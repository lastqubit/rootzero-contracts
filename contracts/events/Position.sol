...
abstract contract PositionEvent is EventEmitter {
    string private constant ABI = "event Position(bytes32 indexed account, bytes32 asset, bytes32 meta, uint value, uint context, uint queryId)";
    ...
    event Position(bytes32 indexed account, bytes32 asset, bytes32 meta, uint value, uint context, uint queryId);
